                    ...
                    <?php foreach ($dompet as $d) : ?>
                        <tr>
                            ...
                            <td style="text-align: center">
                                <a type="button" data-bs-toggle="modal" data-bs-target="<?= isset($d['uangMasuk']) ? '#editMasuk' : '#editKeluar' ?>" class="btn btn-success">Edit</a>
                                <a href="edit/<?= isset($d['uangMasuk']) ? 'masuk/' : 'keluar/' ?><?= $d['id'] ?>" class="btn btn-warning">Edit</a>
